...
[![Paper](https://img.shields.io/badge/📑_Paper-arXiv:2502.11102-b31b1b) ](https://arxiv.org/abs/2502.11102)[![Dataset](https://img.shields.io/badge/🤗-Dataset-ffb7c5) ](https://huggingface.co/datasets/Aurora-Gem/OptMATH-Train)[![GitHub stars](https://img.shields.io/github/stars/optsuite/OptMATH?style=social)](https://github.com/optsuite/OptMATH/stargazers)
...
3. **Validates the correspondence between NL and PD through forward modeling and rejection sampling**
   ![Framework Overview](https://aurora-pics.oss-cn-beijing.aliyuncs.com/Pic/202505061324262.png)
...
* **Covers diverse optimization scenarios including logistics, supply chain, manufacturing etc.**
  ![Application Scenarios Distribution](https://aurora-pics.oss-cn-beijing.aliyuncs.com/Pic/202505061324635.jpg)
...
* **Coverage of various problem types (LP, MILP, IP, NLP, SOCP)**
  ![](https://aurora-pics.oss-cn-beijing.aliyuncs.com/Pic/202505061324602.png)
...
![Performance Comparison](https://aurora-pics.oss-cn-beijing.aliyuncs.com/Pic/202505061324455.png)

### Ablation Study

#### Ablation study on Model Size

![Model Scaling](https://aurora-pics.oss-cn-beijing.aliyuncs.com/Pic/202505061324580.png)
...
**![Data Scaling(1.5B))](https://aurora-pics.oss-cn-beijing.aliyuncs.com/Pic/202505061325832.png)
